...
def build_static_checks(runner_id, d108, manifest, receipt, sandbox_proposal):
...
def create_regression_runner(root=".", execute_commands=True):
    ...
    static_checks = build_static_checks(runner_id, d108, manifest, receipt, sandbox_proposal)
