...
#
# Adds D70 Sandbox Bundle Reviewer to GitCube OS.
#
# Run from repo root:
#     python D70_SANDBOX_BUNDLE_REVIEWER_BOOT.py
#
# Creates:
...
#
# D70 does NOT call an external AI API.
# D70 does NOT patch task_dispatcher.py.
# D70 does NOT mutate protected core.
# D70 does NOT overwrite canonical memory.
#
# D70 consumes D69 sandbox bundle and emits APPROVE / REJECT evidence
# before D64 Safe Mutation Gate is allowed to consider any guarded apply.
...
def review_sandbox_bundle(
    ...
    for rel_raw in written_files:
        ...
        if rel != rel_raw:
            item["checks"]["path_normalized"] = True
...
Path("runtime_experimental/sandbox_bundle_reviewer.py").write_text(REVIEWER_CODE.lstrip(), encoding="utf-8")
